...
function Search() {
  ...
  var handleChange = function handleChange(event) {
    setSearchTerm(event.target.value); // console.log(searchTerm);
  };
  ...
  (0, _react.useEffect)(function () {
    ...
    console.log(searchResults); // console.log(searchTerm)
  }, [searchTerm]);
  ...
  }), /*#__PURE__*/_react.default.createElement("ul", null, searchResults.map(function (item) {
